        ...
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="#" class="flex items-center">
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">ManagerBox</span>
                </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-12 sm:grid-cols-3">
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Equipe</h2>
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
